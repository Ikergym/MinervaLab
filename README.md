...
<table >
    ...
    <tbody>
        ...
        <tr>
            <td>#114-000</td>
            <td>Effect of a and b on the isotherms</td>
        ...
        <tr>
            <td>#119-000</td>
            <td>Effect of a and b on the function</td>
        ...
        <tr>
            <td>#11C-000</td>
            <td>Effect of a and b on the isotherms (reduced variables)</td>
